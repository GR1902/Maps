...
├── data/
│   ├── teams.json             584 club/venue records, keyed by league → team code
│   ├── fixtures.json          2667 fixtures, keyed by league, with matchday numbers
...
|---|---|---|---|
| Premier League | MD1–6 (21 Aug–12 Oct) | High for MD1–5, Medium for MD6 | premierleague.com; **2026-08-24 update:** MD6 (10–12 Oct) kickoff times added via cross-corroborated press coverage (2+ independent sources per fixture) — premierleague.com itself was unreachable this session (see network-access note below the table), so not verified against the primary source directly. MD7–9 broadcast selections were reportedly announced too but not itemized (conflicting snippets) — recheck next pass |
...
| La Liga | MD1–4 (15 Aug–7 Sep) | High | laliga.com structured match data; **corrected several wrong MD1 fixtures** from the previous internal-tool snapshot (wrong pairings/dates); 2026-08-24: MD5 could not be verified (laliga.com unreachable this session, WebSearch snippets described times as still TBD) |
| LaLiga Hypermotion | MD1–4 (14 Aug–7 Sep) | High | laliga.com; replaced the old mostly-placeholder MD1 times with real confirmed ones for all 11 fixtures; 2026-08-24: MD5 could not be verified (same access issue) |
...
| 3. Liga | MD1–7 (7 Aug–20 Sep) | High | Same sourcing; MD6 is a real simultaneous-kickoff midweek round (all 19:00 CEST), not a placeholder; 2026-08-24: MD8/9 reportedly time-scheduled per a dfb.de headline but WebSearch produced mutually contradictory pairings, so nothing added — needs a working direct-fetch recheck |
| Serie A | MD1–5, 48/50 fixtures (22 Aug–20 Sep) | High | legaseriea.it via Wikipedia's mirrored calendar tables, cross-checked against a legaseriea.it news article; 2 MD4 fixtures excluded (Lazio–Milan, Sassuolo–Juventus — kickoff still conditional on the Europa League league-phase draw, now expected 2026-08-28); 2026-08-24 re-check: still no MD6 kickoff times published (round falls after the 21 Sep–6 Oct international break) |
...
| Ligue 1 | MD1–5, 37/45 fixtures (21 Aug–20 Sep) | High for MD1–4, Low for MD5 (1/9 fixtures) | ligue1.com TV-programming articles + official club sites; **2026-08-24:** added the OM–PSG Classique (MD5, 20 Sep) via multiple independent sources — the other 8 MD5 fixtures and all of MD6+ could not be pinned down this pass (ligue1.com/lfp.fr unreachable this session) |
| Ligue 2 | MD1–9, 73/81 fixtures (8 Aug–17 Oct) | High for MD1–4/6/7, Medium for MD5, Low/partial for MD8/MD9 | LFP calendar + club sites; **2026-08-24:** MD5 completed (Boulogne–Dijon added, single ticketing-site source); MD9 opened with only 2 of 9 fixtures added (Red Star–Saint-Étienne, Annecy–Nancy) — the rest came from a single unverified web-search synthesis and were deliberately withheld; MD8's Dunkerque–Annecy still lacks a published kickoff time |
| Primeira Liga | MD1, 3–4, 30/35 fixtures (7 Aug–10 Sep) | High | ligaportugal.pt official calendar API (UTC-native); **2026-08-24:** Braga–Gil Vicente (MD2) was officially postponed indefinitely (squad gastrointestinal outbreak) with no new date announced — removed from the data rather than left stale; MD5+ could not be verified this pass (ligaportugal.pt unreachable, WebSearch results were season-conflated) |
| Eredivisie | MD1–12, 18, 33, 34 (7 Aug 2026–23 May 2027) | High | eredivisie.nl live fixture feed (the *rendered page* had a 1-hour display bug — feed data was used instead, verified against press); 1 postponed fixture (NEC–Excelsior) excluded — 2026-08-24: KNVB has now set two conditional make-up dates (8 or 16 Sep) pending the outcome of NEC's Champions League play-off return leg (25 Aug), so still no single confirmed date to add; KNVB also confirmed MD13–21 dates won't be announced before 8 Sep, matching current coverage |
| Eerste Divisie | MD1–38, full season (7 Aug 2026–14 May 2027) | High, single-source | keukenkampioendivisie.nl's official schedule API — every match all season has a distinct real time, but from one source only; 2026-08-24 postponement spot-check could not be completed (search budget exhausted) — recheck next pass |
| Pro League (BEL) | MD1–7 (7 Aug–20 Sep) | High | proleague.be + voetbalkrant.com cross-check; **corrected several wrong kickoff times and a few home/away swaps** in the old MD1 data; **2026-08-24:** 3 MD3 fixtures (Anderlecht–KV Kortrijk, Gent–OH Leuven, Sint-Truiden–Union SG) rescheduled to 2–3 Sep to free up European-tie windows for Anderlecht/Gent, confirmed across multiple Belgian outlets; a further MD5 Anderlecht–Gent fixture is also postponed with no new date yet |
| Challenger Pro League (BEL) | MD1–6 (14 Aug–20 Sep) | High | Same sourcing; **fixed two reversed home/away fixtures** (Seraing–Lokeren, Eupen–Jong Genk); 15 clubs, rotating bye each round is expected, not a gap; 2026-08-24 re-check found no changes (lower-confidence pass — direct site access unavailable, search budget limited) |
| Allsvenskan (SWE) | Rounds 17–23 (14 Aug–12 Oct) | High | allsvenskan.se, cross-checked against Svensk Elitfotboll; 2026-08-24: round 24+ could not be verified — WebSearch results repeatedly conflated other seasons' schedules, nothing met the confidence bar |
| Eliteserien (NOR) | Rounds 18–22 (14 Aug–20 Sep) | High | Official NFF/fotball.no database; the old placeholder Bodø/Glimt–Start fixture was found to have **already been played back in April** and was dropped rather than given a fake future date; 2026-08-24: round 23+ could not be verified this pass |
| Superliga (DEN) | Rounds 3(makeup)–9 (14 Aug–20 Sep) | High | Live from superliga.dk (web-search summaries were discarded as stale); fixed a matchday mislabel (Randers–FCK was tagged round 3, actually round 4); 2026-08-24: round 10+ could not be verified this pass |
| Veikkausliiga (FIN) | Rounds 20–22, end of regular season (14–31 Aug) | High–Medium-high | Official fixtures listing; rounds 23+ (post-season split) not yet published — 2026-08-24 re-check confirms still unpublished, expected first split matchday is 9 Sep |
| Scottish Premiership | MD1–6, 23/... fixtures (31 Jul–20 Sep) | High | spfl.co.uk / club statements; **2026-08-24:** Falkirk–Hearts (postponed MD2) now rescheduled to 15 Sep and added; the full MD5 round (6 fixtures) and the MD6 Old Firm derby (Celtic–Rangers, 20 Sep) are now confirmed; Rangers–St Mirren and St Johnstone–Celtic (also postponed MD2) remain unconfirmed pending UEFA qualifying outcomes |
| Swiss Super League | MD1, 4–10 (25 Jul–11 Oct) | Very high | Official SFL/blue Sport calendar PDF, which explicitly marks Rounds 1–10 as time-confirmed; **2026-08-24:** the previously-blank Thun–Servette (MD4) fixture is now confirmed (22 Aug); rounds 11+ kickoff times aren't published by the SFL until the second half of September |
| Austrian Bundesliga | MD1, 3–6 (31 Jul–13 Sep) | High for MD1–5, Medium for MD6 (single source) | bundesliga.at team pages; **the previously-assumed MD1 dates for Wolfsberger AC–Austria Wien and Austria Lustenau–SV Ried were corrected** to the actual played date (2 Aug); **2026-08-24:** all 6 MD6 fixtures added via laola1.at's report of the official bundesliga.at release — single secondary source, not independently cross-verified due to search-budget limits this pass, recommend a follow-up spot-check |
| Greek Super League | MD1–2 (22–31 Aug) | High | seleo.gr / betarades.gr; replaced the old one-flat-time placeholder with real per-match times; **2026-08-24:** MD2 (7 fixtures) added, cross-confirmed across multiple Greek outlets; MD3 pairings are known but not yet time-confirmed |
| Turkish Süper Lig | MD1–3 (14–31 Aug) | High | sporx.com; MD1 unchanged from prior high-confidence data; 2026-08-24 re-check found MD4 pairings known but not yet time-confirmed by the TFF |
| Polish Ekstraklasa | MD1, 4–8, 44 fixtures (24 Jul–12 Sep) | High for MD1–7, Low/partial for MD8 (1 fixture, single source) | ekstraklasa.org official terminarz; MD1 re-derived from final-score reports, **fixing a wrong date+time** for Wisła Kraków–GKS Katowice; **2026-08-24:** Raków–Górnik Zabrze (previously postponed MD5) now confirmed for 3 Sep; Zagłębie Lubin–GKS Katowice (MD8) added from the club's own official terminarz; Korona Kielce–Górnik Zabrze remains undated pending Górnik's Conference League qualifier outcome |
| Czech First League (Chance Liga) | MD1, 4–5 (25 Jul–23 Aug) | High | fotbal.cz; MD1's previously-uncertain Artis Brno–Mladá Boleslav game confirmed at 18:00 local; 2026-08-24: MD6+ could not be verified this pass (site unreachable, search budget exhausted before per-fixture times were found) |
| Croatian HNL | MD1, 3–4 (31 Jul–23 Aug) | High | hns-cff.hr official raspored; MD2 intentionally skipped (already played before the research date); 2026-08-24: MD5+ could not be verified this pass |
| UEFA Champions League | Play-off round, MD1, 7 ties/14 legs (18–26 Aug) | High | Wikipedia's mirror of uefa.com's fixture calendar, cross-validated by independently converting each kickoff's two given timezones to UTC and confirming they agreed; 2026-08-24: League Phase draw (36-team single table) is set for 27 Aug, MD1 window 8–10 Sep — nothing to add until the draw happens |
| UEFA Europa League | Play-off round, MD1, 6/12 return legs (27 Aug) | Medium — 2+ sources per fixture, uefa.com itself unreachable this session | **2026-08-24:** first fixtures added for this competition — the previously-undetermined tie resolved as FC Thun vs KKS Lech Poznań (added as a new team); 6 of 12 return-leg kickoffs (27 Aug) confirmed via cross-corroborated club/broadcast sources, the other 6 pairings are confirmed for 27 Aug but their times came from a single aggregator without clear timezone attribution and were withheld; first legs (20 Aug, already played) were not added since no kickoff times were found for them |
| UEFA Conference League | Play-off round pairings/dates only, no fixtures yet (draw 27 Aug) | Pairings/dates High, times none | Same situation as Europa League was on 8/13 — teams are in `teams.json` for when times land, no fixtures yet; 2026-08-24 re-check: the league-phase draw (folding in CL/EL play-off losers) hasn't happened yet, nothing to add |

**2026-08-24 weekly update — network-access caveat:** this run's execution
environment blocked outbound `WebFetch`/direct HTTP access to every external
domain tested (official league sites, Wikipedia, even plain control domains),
so all research this pass relied on `WebSearch` result snippets rather than
directly fetched pages. That's a materially weaker verification method than
the 2026-08-13 pass — snippets were occasionally stale, season-conflated, or
internally contradictory, so several leagues were left unchanged
(`skipped_could_not_verify` rather than risk a bad date) even where new data
likely exists, and every fixture added this run was held to a stricter bar
(2+ independent corroborating sources, or an official-adjacent primary page
like a club's own ticketing/terminarz listing). See each row's Notes above
