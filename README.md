...
├── data/
│   ├── teams.json             592 club/venue records, keyed by league → team code
│   ├── fixtures.json          2772 fixtures, keyed by league, with matchday numbers
...
| UEFA Champions League | Play-off round (MD1) + League Phase MD1 (MD2), 13 ties/20 legs (18 Aug–10 Sep) | High | Wikipedia's mirror of uefa.com's fixture calendar, cross-validated by independently converting each kickoff's two given timezones to UTC and confirming they agreed; 2026-08-24: League Phase draw set for 27 Aug — nothing to add until the draw happens. **2026-08-31:** draw held 27 Aug in Monaco (36-team single table); added confirmed, time-verified MD1 (8-10 Sep) fixtures for our 7 tracked play-off winners (AEK, LASK, Viking, Slovan Bratislava, Sabah, Fenerbahçe, Bodø/Glimt), stored as matchday 2 — treat this league's matchday numbering as competition-internal (1=play-off round, 2=League Phase MD1, ...), not UEFA's own numbering. Added Bayern Munich/Stuttgart/PSG/Roma/Man Utd as duplicate entries from their domestic leagues (marker-merge convention) plus a country tag. Only fixtures involving our 7 tracked clubs are in scope — the other 29 League Phase clubs aren't tracked |
| UEFA Europa League | Play-off round, MD1, full 12/12 return legs (27 Aug) | Medium — 2+ sources per fixture, uefa.com itself unreachable this session | **2026-08-24:** first fixtures added — the previously-undetermined tie resolved as FC Thun vs KKS Lech Poznań; 6 of 12 return-leg kickoffs confirmed, the other 6 withheld (single-aggregator times only); first legs (20 Aug) not added, no kickoff times found. **2026-08-31:** filled in the remaining 6 return legs, now confirmable from post-match reports (UEFA.com match pages + independent time-listing sites) — including a corrected Lillestrøm/Egnatia home-leg mix-up, resolved via UEFA match-ID sequencing. League Phase MD1 (16-17 Sep) draw/kickoff-time research didn't happen this pass — shared search budget ran out — recheck next pass |
| UEFA Conference League | Play-off round (MD1) + League Phase MD1 (MD2), partial, 13/61 fixtures (20 Aug–15 Oct) | Medium — 2+ sources per added fixture, most legs still withheld for a single source | 2026-08-24: league-phase draw (folding in CL/EL play-off losers) hadn't happened yet, nothing to add. **2026-08-31:** play-off round (20 & 26-27 Aug) complete — 8 of 48 legs' kickoff times confirmed via cross-corroborated sources, rest withheld for lack of a second source; league-phase draw held 28 Aug in Monaco; 5 of 18 MD1 (15 Oct) fixtures now have corroborated kickoff times. Added Universitatea Craiova and Crvena Zvezda as new teams (coordinates from Wikipedia/StadiumDB); AGF Aarhus (dropped in after losing its Europa League play-off to Benfica) reuses its europa_league entry unchanged. Matchday numbering follows the same competition-internal convention as champions_league |
